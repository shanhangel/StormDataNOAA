...
and unzipped in the 
```{r, cache=TRUE}
download.file("http://biogeo.ucdavis.edu/data/gadm2/shp/USA_adm.zip",
              "USA_adm.zip")
```
...
USMap <- readShapePoly(fn="./USA_adm/USA_adm1.shp")
plot(USMap)
```
...
[2] http://www.r-bloggers.com/maps-in-r-choropleth-maps/